...
parser_list.set_defaults({ "func": functions_1.listDepositions });
...
parser_create.set_defaults({ "func": functions_1.create });
...
parser_duplicate.set_defaults({ "func": functions_1.duplicate });
...
parser_update.set_defaults({ "func": functions_1.update });
...
parser_upload.set_defaults({ "func": functions_1.upload });
...
parser_copy.set_defaults({ "func": functions_1.copy });
...
parser_newversion.set_defaults({ "func": functions_1.newVersion });
...
parser_download.set_defaults({ "func": functions_1.download });
